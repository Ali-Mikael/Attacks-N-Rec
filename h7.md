...
git clone used with the  `--depth=1` flag only installs the latest version, not the whole repo!    
...
We zoom in on a bit, and mark it as closely as possible from beginning to end, and get a value: **533µs**    
(µs = microseconds)     
