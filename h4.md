...
# 1. Inspect RFID products you use, consider how well you are protected against RFID prying.
...
**Answer:**      
Short answer: In theory yes, but in practice it's extremely unlikely and almost useless.
- A rogue NFC reader could be placed physically between the card and the real terminal, but:
  ...
  - So while technically possible, it’s not a practical or effective attack.      

Also found an intriguing video through the link Lari provided (<https://bishopfox.com/tools/rfid-hacking-2/attack-tools>).     
