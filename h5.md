...
- I guess you can't run this without TLS. Only thing left to do is to just figure it out.     

# Go Phish Part 2 (this is later)
**Starting completely over** (start evilginx in developer mode):    
...
**Generate own ssl-snakeoil certs and place them in** `~/.evilginx/crt/sites/*`:
...
The *phishlets help menu* nudged me in the righ direction, and ultimately gave me two domains to add to my `/etc/hosts` file, which I then did:
