...
A simple config of `/etc/hosts` on the "victim" will do the trick. 
...
I had some issues getting this to work with my snakeoil cert. (Writing this from the future: it was a very simple command you will see in part two 😂)
...
#### Copy cert to >> ~/.evilginx/crt/sites/*
...
#### Disable LetsEncrypt:     
> This is the key piece that was missing before.     
...
I then disabled the phishlet -> Rebooted the machine -> Fired up evilginx -> Enabled the phishlet -> Created a new lure -> Pasted the link in my browser:
