...
- Because the first site tried to offer Realtek as the answer for some reason, I still wanted to check it off the list and did some research:
...
- This way I could safely cross it off the list and end up with my conclusion:
  - The NIC belonging to host `192.168.122.7` does in fact not have a brand, but is software based, meaning a Virtual NIC offered by KVM = the virtualization solution.      



## H) - What webserver(s) has been hosting our guest
Two webservers atleast for what I could find:
- google.com & terokarvinen.com      
...
*Frame 431:*
- We are getting a DNS response to a query we initiated
...
*Frame 434:*
- We are initiating a connection to the webserver hosting github.com
...
*Frame 470:*
- We are sending a client-hello packet to the server
