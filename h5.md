...
#### Disable LetsEncrypt:     
> This is the key piece that was missing before. (I had the old certs straight under `/.evilginx/crt`)     
> Found it randomly on a twitter post made by the author of the tool, while googling for solutions on my phone before bed 😂            
...
- This is the post I found:
  - <img width="292,5" height="633" alt="IMG_8600" src="https://github.com/user-attachments/assets/253b0919-4f21-452a-8e98-1266b8897b48" />
...
# B) Mininet
### Objective: Create an environment, where you can do a TCP SYN-flood attack. 
> Report on how you created the environment and executed the attack    
