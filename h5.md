...
This is the phishlet I went with:
```bash
...
#### Copy crt to >> ~/.evilginx/crt/sites/*
...
I was provided with two domains to add to my `/etc/hosts` file, which I then did:
...
<img width="260" height="51" alt="Screenshot from 2025-12-02 17-39-23" src="https://github.com/user-attachments/assets/b7c3f809-2563-46e8-aa0e-75347c207e0b" />     
