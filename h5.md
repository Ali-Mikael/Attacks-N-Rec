...
- I guess you can't run this without TLS. So the only thing left to do, is to just figure it out!     
...
- Authors phishlets github repo: <https://github.com/webdevvx/evilginx-phishlets/tree/main>    

**Set the hostname for the phishlet and enabled it:**
...
**Generate ssl-snakeoil certs** 
```
sudo make-ssl-cert generate-default-snakeoil
```

**And place them in** `~/.evilginx/crt/sites/*`:
...
**Type in credentials to log in and whatch out for the console:**     
